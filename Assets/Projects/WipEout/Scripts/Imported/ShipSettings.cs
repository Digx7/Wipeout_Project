...
{
    /* Description --
     *  This script holds all the stats for the ship
     */
    /* Notes --
     *  I may need reoptimize this to make it a class instead
     */
    ...
    public float speed = 100.0f; // Changeable by parts
    public float reverseSpeed = 75.0f; 
    public float acceleration = 80.0f; // Changeable by parts
    public float accelerationMin = 10.0f;
    public float brake = 60.0f;
    public float deceleration = 0.5f;
    public float airBrake = 2.0f; // Changeable by parts
    public float steerSpeed = 3.0f; // Changeable by parts
